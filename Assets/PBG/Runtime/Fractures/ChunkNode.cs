...
namespace PBG.Runtime.Fractures
{
    ...
    {
        public HashSet<ChunkNode> Neighbours = new();
        public ChunkNode[] NeighboursArray = new ChunkNode[0];
        private Dictionary<Joint, ChunkNode> JointToChunk = new();
        private Dictionary<ChunkNode, Joint> ChunkToJoint = new();
        ...
        public void Setup()
        {
            ...
            foreach (var chunkNode in ChunkToJoint.Keys)
            {
                ...
                if (chunkNode.Contains(this) == false) chunkNode.Neighbours.Add(this);
            }
